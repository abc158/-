...
typedef enum
{
  ...
  LT_FRONT_LEFT_THRESHOLD_ON    = 1000, /*前左*/
  LT_FRONT_LEFT_THRESHOLD_OFF   = 1000,
  LT_FRONT_RIGHT_THRESHOLD_ON   = 1000, /*前右*/
  LT_FRONT_RIGHT_THRESHOLD_OFF  = 1000
}LT_E;
...
typedef enum
{
  ...
  UI_SET_LT_BUMP_LEFT_RIGHT_THROD = 1000,
...
typedef enum
{
  ...
  VACUUM_NORMAL_VOLTAGE      = 2500, /*1700*/
