...
{  
  ...
  CLIFF_LEFT_THRESHOLD_ON              = 100, /*左*/
  CLIFF_LEFT_THRESHOLD_OFF             = 100, 
  CLIFF_RIGHT_THRESHOLD_ON             = 100, /*右*/
  CLIFF_RIGHT_THRESHOLD_OFF            = 100,
  CLIFF_FRONT_LEFT_THRESHOLD_ON        = 100, /*前左*/
  CLIFF_FRONT_LEFT_THRESHOLD_OFF       = 100,
  CLIFF_FRONT_RIGHT_THRESHOLD_ON       = 100, /*前右*/
  CLIFF_FRONT_RIGHT_THRESHOLD_OFF      = 100
}CLIFF_E;
...
typedef enum
{
  LT_CENTERLEFT_THRESHOLD_ON    = 1100, /*中间左*/
  LT_CENTERLEFT_THRESHOLD_OFF   = 1100,
  LT_CENTERRIGHT_THRESHOLD_ON   = 1100, /*中间右*/
  LT_CENTERRIGHT_THRESHOLD_OFF  = 1100,
  LT_LEFT_THRESHOLD_ON          = 600, /*左*/
  LT_LEFT_THRESHOLD_OFF         = 600,
